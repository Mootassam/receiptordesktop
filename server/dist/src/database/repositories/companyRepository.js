...
class CompanyRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const list = yield (0, company_1.default)(options.database).find();
            let record;
            if (list && list.length > 0) {
                this.update(list[0]._id, data, options);
            }
            else {
                [record] = yield (0, company_1.default)(options.database).create([
    ...
    static findContact(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const record = yield (0, company_1.default)(options.database).find();
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists((0, company_1.default)(options.database).findOne({
                _id: id,
            ...
            yield (0, company_1.default)(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, company_1.default)(options.database).deleteOne({ _id: id }, options);
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield (0, company_1.default)(options.database)
                .find({
                _id: { $in: ids },
                tenant: currentTenant.id,
            })
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists((0, company_1.default)(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    ...
    static findAndCountAll(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ filter, limit = 0, offset = 0, orderBy = "" }, options) {
            ...
            let rows = yield (0, company_1.default)(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort);
            const count = yield (0, company_1.default)(options.database).countDocuments(criteria);
