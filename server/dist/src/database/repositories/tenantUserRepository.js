...
class TenantUserRepository {
    static findByInvitationToken(invitationToken, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let user = yield mongooseRepository_1.default.wrapWithSessionIfExists((0, user_1.default)(options.database)
                .findOne({
    ...
    static create(tenant, user, roles, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, user_1.default)(options.database).updateMany({ _id: user.id }, {
                $push: {
                    tenants: {
                        tenant: tenant.id,
                        status,
    ...
    static destroy(tenantId, id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield mongooseRepository_1.default.wrapWithSessionIfExists((0, user_1.default)(options.database).findById(id), options);
            yield mongooseRepository_1.default.wrapWithSessionIfExists((0, user_1.default)(options.database).updateOne({ _id: id, "tenants.tenant": tenantId }, {
                $set: {
                    "tenants.$.roles": [],
    ...
    static updateRoles(tenantId, id, roles, options, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield mongooseRepository_1.default.wrapWithSessionIfExists((0, user_1.default)(options.database).findById(id).populate("tenants.tenant"), options);
            ...
            (tenantUser.status = status),
                ...
                //   newRoles,
                // );
                yield (0, user_1.default)(options.database).updateOne({ _id: id, "tenants.tenant": tenantId }, {
                    $set: {
