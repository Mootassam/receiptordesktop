...
const socialRepository_1 = __importDefault(require("../../database/repositories/socialRepository"));
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = yield socialRepository_1.default.update(req.params.id, req.body.number, req);
