...
const depositMethodService_1 = __importDefault(require("../../services/depositMethodService"));
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.categoryRead);
        const payload = yield new depositMethodService_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
...
//# sourceMappingURL=depositMethodAutocomplete.js.map