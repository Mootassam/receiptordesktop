...
const userMessageServices_1 = __importDefault(require("../../services/userMessageServices"));
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.categoryRead);
        const payload = yield new userMessageServices_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
...
//# sourceMappingURL=userMessageAutocomplete.js.map