...
exports.default = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const stripe = require('stripe')((0, config_1.getConfig)().PLAN_STRIPE_SECRET_KEY);
        const event = stripe.webhooks.constructEvent(req.rawBody, req.headers['stripe-signature'], (0, config_1.getConfig)().PLAN_STRIPE_WEBHOOK_SIGNING_SECRET);
