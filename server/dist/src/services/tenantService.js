...
class TenantService {
     ...
     * to new users.
     */
    createOrJoinDefaultMobile(_a, session_1) {
        return __awaiter(this, arguments, void 0, function* ({ roles }, session) {
    ...
    createOrJoinDefault(_a, session_1) {
        return __awaiter(this, arguments, void 0, function* ({ roles }, session) {
            const tenant = yield tenantRepository_1.default.findDefault(Object.assign(Object.assign({}, this.options), { session }));
            if (tenant) {
                // Reload the current user in case it has chenged
    ...
    joinWithDefaultRolesOrAskApproval(_a, _b) {
        return __awaiter(this, arguments, void 0, function* ({ roles, tenantId }, { session }) {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if ((0, config_1.getConfig)().TENANT_MODE === 'single') {
    ...
    acceptInvitation(token_1) {
        return __awaiter(this, arguments, void 0, function* (token, forceAcceptOtherEmail = false) {
            const session = yield mongooseRepository_1.default.createSession(this.options.database);
            try {
