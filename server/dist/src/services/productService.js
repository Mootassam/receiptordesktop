...
class ProductServices {
    ...
    findByCoin(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return productRepository_1.default.findByCoin(id, this.options);
        });
    }
    findNews(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const id = data.id;
            return productRepository_1.default.FindNews(id, page, size, this.options);
        });
    }
    findTopCoins(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return productRepository_1.default.findTopCoins(data, this.options);
        });
    }
    ...
    checkPermission(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.balance) && (currentUser === null || currentUser === void 0 ? void 0 : currentUser.balance) === 0) {
                throw new Error400_1.default(options.language, "errors.resetAccountContactSupport");
            }
        });
    }
    grapOrders(args) {
