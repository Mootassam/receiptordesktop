...
const serviceAccount = JSON.parse((0, config_1.getConfig)().GOOGLE_CLOUD_PLATFORM_CREDENTIALS);
...
class GoogleCloudFileStorage {
    ...
    static downloadUrl(privateUrl, publicRead, tokenExpiresAt) {
        return __awaiter(this, void 0, void 0, function* () {
            if (publicRead) {
                return `https://storage.googleapis.com/${(0, config_1.getConfig)().FILE_STORAGE_BUCKET}/${privateUrl}`;
            }
            tokenExpiresAt =
