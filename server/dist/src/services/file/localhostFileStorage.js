...
class LocalFileStorage {
    ...
    static uploadCredentials(privateUrl, maxSizeInBytes, publicRead, tokenExpiresAt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = jsonwebtoken_1.default.sign({ privateUrl, maxSizeInBytes }, (0, config_1.getConfig)().AUTH_JWT_SECRET, { expiresIn: expires });
            return {
                url: `${(0, config_1.getConfig)().BACKEND_URL}/file/upload?token=${token}`,
            };
        });
    }
    /**
    ...
    static upload(fileTempUrl, privateUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                (0, mv_1.default)(fileTempUrl, internalUrl, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    static downloadUrl(privateUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            return `${(0, config_1.getConfig)().BACKEND_URL}/file/download?privateUrl=${privateUrl}`;
        });
    }
    /**
     * Downloads the file.
