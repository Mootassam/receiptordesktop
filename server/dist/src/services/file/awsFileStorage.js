...
const s3 = new aws.S3({
    accessKeyId: (0, config_1.getConfig)().AWS_ACCESS_KEY_ID,
    secretAccessKey: (0, config_1.getConfig)().AWS_SECRET_ACCESS_KEY,
});
class AWSStorage {
    /**
    ...
    static uploadCredentials(privateUrl, maxSizeInBytes, publicRead, tokenExpiresAt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const policy = yield s3.createPresignedPost({
                Bucket: (0, config_1.getConfig)().FILE_STORAGE_BUCKET,
                Fields,
    ...
    static downloadUrl(privateUrl, publicRead) {
        return __awaiter(this, void 0, void 0, function* () {
            if (publicRead) {
                return `https://${(0, config_1.getConfig)().FILE_STORAGE_BUCKET}.s3.amazonaws.com/${privateUrl}`;
            }
            const params = {
                Key: privateUrl,
                Bucket: (0, config_1.getConfig)().FILE_STORAGE_BUCKET,
