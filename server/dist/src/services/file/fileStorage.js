...
let FileStorage;
if ((0, config_1.getConfig)().FILE_STORAGE_PROVIDER === 'gcp') {
    FileStorage = require('./googleCloudFileStorage').default;
}
if ((0, config_1.getConfig)().FILE_STORAGE_PROVIDER === 'aws') {
    FileStorage = require('./awsFileStorage').default;
}
if ((0, config_1.getConfig)().FILE_STORAGE_PROVIDER === 'localhost') {
