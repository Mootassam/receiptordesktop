...
class TransactionService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const record = yield TransactionRepository_1.default.create(data, Object.assign(Object.assign({}, this.options), { session }));
    ...
    checkpermission(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentUser.withdraw)
                return;
            throw new Error400_1.default(options.language, "errors.contactCustomerService");
        });
    }
    checkSolde(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUser = mongooseRepository_1.default.getCurrentUser(options);
            if (!data) {
                throw new Error400_1.default(options.language, "errors.pleaseWriteAmount");
            }
            ...
            if (type === "withdraw") {
                if (currentUser.withdrawPassword == data.withdrawPassword) {
                    if (currentUser.balance < amount) {
                        throw new Error400_1.default(options.language, "errors.withdrawalExceedsBalance");
                    }
                }
                else {
                    throw new Error400_1.default(options.language, "errors.withdrawPasswordIncorrect");
                }
            }
        });
    }
    ...
    findAndCountAllMobile(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return TransactionRepository_1.default.findAndCountAllMobile(args, this.options);
        });
    }
    countReward(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return TransactionRepository_1.default.totalReward(this.options);
        });
    }
