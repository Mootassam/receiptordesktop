...
class Plans {
    ...
    static selectPlanByStripePriceId(stripePriceId) {
        const growthStripePriceId = (0, config_1.getConfig)()
            .PLAN_STRIPE_PRICES_GROWTH;
        const enterpriseStripePriceId = (0, config_1.getConfig)()
    ...
    static selectStripePriceIdByPlan(plan) {
        if (plan === Plans.values.growth) {
            return (0, config_1.getConfig)().PLAN_STRIPE_PRICES_GROWTH;
        }
        if (plan === Plans.values.enterprise) {
            return (0, config_1.getConfig)().PLAN_STRIPE_PRICES_ENTERPRISE;
        }
        return null;
    }
    /**
