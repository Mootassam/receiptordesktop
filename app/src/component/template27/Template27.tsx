...
const Template27: React.FC<Template27Props> = ({ formData }) => {
  ...
  // Amount and fee in USD (from formData)
  const amountUSD = parseNumber(formData.amount, 20.50);
  const feeUSD = parseNumber(formData.fee, 0.50);

  // Effective ETH/USD rate
  ...
  // Format ETH with 8 decimals (but we'll show a reasonable fraction)
  ...
  // Format address into shortened form like "0xbB31B...2ca85"
  const formatShortAddress = (address: string | undefined, defaultAddr: string): string => {
  ...
  // Default addresses
  const defaultSender = '0xbB31B2ca85f5y0it...2ca85';
  const defaultReceiver = '0xe20da5808f...5808f';

  const shortSender = formatShortAddress(formData.sender, defaultSender);
  const shortReceiver = formatShortAddress(formData.receiver, defaultReceiver);

  // Format transaction hash (txid) – unchanged
  ...
  // Format address into two lines with indentation (used elsewhere)
          ...
          <div className="groups-e">
            ...
            <div className="groups-f">
              ...
              <div className="image-11" />
               <span className="oct-time">{Dates.formatTemplate27(formData.date)}</span>
            </div>
            <div className="groups-12">
              ...
              <div className="flex-row-ebc">
                <span className="confirmed-13">Confirmed</span>
                 <span className="oct-time-14">{Dates.formatTemplate27(formData.date)}</span>
              </div>
            </div>
            ...
            <div className="groups-16">
              ...
              <div className="group-3">
                <div className="pic-5" />
                <div className="img-6" />
                {/* Updated sender and receiver with short format */}
                <span className="text-13">{shortSender}</span>
                <span className="text-14">{shortReceiver}</span>
              </div>
            </div>
            <div className="img-7" />
          </div>
            ...
            <div className="group-4">
              <div className="section-a">
                <div className="wrapper-7">
                  ...
                  {/* Dynamic Amount ETH */}
                  <span className="eth-17">{formatETH(amountETH)} ETH</span>
                </div>
                <div className="flex-row-f">
                  <span className="estimated-gas-fee">Estimated gas fee</span>
                  {/* Dynamic Gas Fee ETH */}
                  <span className="eth-18">{formatETH(feeETH)} ETH</span>
                </div>
              ...
              <div className="groups-1b">
                <div className="flex-row-ce">
                  ...
                  {/* Dynamic Total ETH */}
                  <span className="eth-1c">{formatETH(totalETH)} ETH</span>
                </div>
                {/* Dynamic Total USD */}
                <span className="dollar">{formatUSD(totalUSD)}</span>
              </div>
            </div>
