...
.image {
  ...
  right: 17.5px;
  bottom: 12.5px;
  background: url(${assetBase}template26/gfa3C08ah1.png)
    no-repeat center;
...
.image-3 {
  ...
  right: 46.25px;
  bottom: 12.5px;
  background: url(${assetBase}template26/nT4bYqAoFJ.png)
    no-repeat center;
  background-size: cover;
  z-index: 42;
}
.image-4 {
  ...
  right: 66.875px;
  bottom: 13.125px;
  background: url(${assetBase}template26/pQvq1RWJx7.png)
    no-repeat center;
  background-size: cover;
  z-index: 43;
}
...
.image-6 {
  ...
  background: url(${assetBase}template26/8T5Ukf6jzM.png)
    no-repeat center;
  background-size: cover;
  z-index: 39;
}
...
.image-8 {
  ...
  background: url(${assetBase}template26/xcUPLjUY5a.png)
    no-repeat center;
  background-size: cover;
  z-index: 37;
}
...
.image-9 {
  ...
  right: 316.25px;
  bottom: 23.125px;
  background: url(${assetBase}template26/dg7U7nocwX.png)
    no-repeat center;
  background-size: cover;
  z-index: 33;
}
...
.image-d {
  ...
  right: 293.75px;
  bottom: 18.125px;
  background: url(${assetBase}template26/CXOx6RZ8Yf.png)
    no-repeat center;
  background-size: cover;
  z-index: 27;
}
...
.image-f {
  ...
  right: 151.875px;
  bottom: 18.75px;
  background: url(${assetBase}template26/OkqF1C9GOs.png)
    no-repeat center;
  background-size: cover;
  z-index: 23;
}
...
.image-12 {
  ...
  right: 23.75px;
  bottom: 20px;
  background: url(${assetBase}template26/iqngHerTxC.png)
    no-repeat center;
  background-size: cover;
  z-index: 18;
}
...
.image-14 {
  ...
  right: 23.75px;
  bottom: 26.25px;
  background: url(${assetBase}template26/XUDS49yZP3.png)
    no-repeat center;
  background-size: cover;
  z-index: 14;
}
...
.background-18 {
  ...
  background: url(${assetBase}template26/ENec1fFnum.png)
    no-repeat center;
  background-size: cover;
  z-index: 2;
}
