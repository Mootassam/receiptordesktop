...
.image {
  ...
  right: 17.5px;
  bottom: 17.5px;
  background: url(${assetBase}template24/N0PXyygpDk.png)
    no-repeat center;
...
.image-1 {
  ...
  right: 46.25px;
  bottom: 17.5px;
  background: url(${assetBase}template24/rW6ttMqnMm.png)
    no-repeat center;
  background-size: cover;
  z-index: 29;
}
.image-2 {
  ...
  right: 66.875px;
  bottom: 18.125px;
  background: url(${assetBase}template24/BAj0k1a2sW.png)
    no-repeat center;
  background-size: cover;
  z-index: 30;
}
...
.image-4 {
  ...
  right: 335px;
  bottom: 10.625px;
  background: url(${assetBase}template24/OSBoAVAb4r.png)
    no-repeat center;
  background-size: cover;
  z-index: 26;
}
...
.image-7 {
  ...
  right: 116.25px;
  bottom: 6.875px;
  background: url(${assetBase}template24/YXJ2vqsrxy.png)
    no-repeat center;
  background-size: cover;
  z-index: 21;
}
...
.background-c {
  ...
  background: url(${assetBase}template24/q4YgcoFgG0.png)
    no-repeat center;
  background-size: cover;
  z-index: 1;
}
