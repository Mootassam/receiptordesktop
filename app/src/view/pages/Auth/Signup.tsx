...
function Signup() {
  ...
  const onSubmit = ({ email, password, rememberMe }) => {
    dispatch(actions.doRegisterEmailAndPassword(email, password, rememberMe));
  };
    ...
    <div className="signin-container">
      <div className="signin-wrapper">
        ...
        <div className="signin-card">
          <h1 className="signin-title">{i18n("auth.signup")}</h1>
          <p className="signin-subtitle">{i18n("auth.signupdesc")}</p>
