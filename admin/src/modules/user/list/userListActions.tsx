...
const userListActions = {
  ...
  HARD_DESTROY_STARTED: `${prefix}_HARD_DESTROY_STARTED`,
  HARD_DESTROY_SUCCESS: `${prefix}_HARD_DESTROY_SUCCESS`,
  HARD_DESTROY_ERROR: `${prefix}_HARD_DESTROY_ERROR`,
  ...
  doHardDestroy: (id) => async (dispatch) => {
    try {
      dispatch({
        type: userListActions.HARD_DESTROY_STARTED,
      });

      await UserService.destroyPermanent([id]);

      dispatch({
        type: userListActions.HARD_DESTROY_SUCCESS,
      });
      ...
      Errors.handle(error);
      dispatch({
        type: userListActions.HARD_DESTROY_ERROR,
      });
      dispatch(userListActions.doFetchCurrentFilter());
    }
  },
